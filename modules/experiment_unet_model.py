...
class r0ImprovedUNet(nn.Module):
    def __init__(self, args):
        super(r0ImprovedUNet, self).__init__()
        ...
        self.layer2_1x1 = ConvReLU(64, 64, 3, 1)
        self.layer1_1x1 = ConvReLU(64, 64, 3, 1)
        self.layer0_1x1 = ConvReLU(64, 64, 3, 1)
